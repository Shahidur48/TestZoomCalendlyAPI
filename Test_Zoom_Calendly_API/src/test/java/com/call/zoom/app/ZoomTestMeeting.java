...
class CallingZoom {
	...
	String access_toke = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJhdWQiOm51bGwsImlzcyI6IlNyNzhBTEExUUFXbmhyRVVmSlFKeEEiLCJleHAiOjE1ODgzMDQwNzYsImlhdCI6MTU4NzY5OTI3OH0.TMwT3bpmdbY9Z_f9R1Sh8IMXlqo9u8OaX603DgSKhQA";
	
	void createMeeting(MeetingDataModel md) {
		...
		Request request = new Request.Builder()
				  .url("https://api.zoom.us/v2/users/G8S05zC4RMCtMSXl0pLwFw/meetings")
				  .method("POST", body)
	...
	Boolean cancelMeeting(MeetingDataModel md)
	{
		...
		Request request = new Request.Builder()
		  .url("https://api.zoom.us/v2/meetings/"+md.getMeetingID()+"")
		  .method("DELETE", body)
		  .addHeader("Content-Type", "application/json")
		  .addHeader("Authorization", "Bearer "+access_toke+"")
		  .build();
